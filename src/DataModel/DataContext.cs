...
namespace Kcsara.Database.Data
{
  ...
  public interface IDataContext : IDisposable
  {
    ...
    IDbSet<MemberContactTypeRow> ContactTypes { get; set; }
  }
  ...
  public class DataContext : DbContext, IDataContext
  {
    ...
    public IDbSet<MemberContactTypeRow> ContactTypes { get; set; }

    public DataContext() : base("DataStore") { }

    public DataContext(string connection) : base(connection) { }

    //    public DataContext(string connName, Guid user)
    //      : base(connName)
    //    {
    //      this.usernameGetter = usernameGetter ?? (() => Thread.CurrentPrincipal.Identity.Name);
    //    }

    //    public DataContext(string connName, Action<string> logMethod)
    //      : this(connName, null)
    //    {
