...
namespace Kcsara.Database.Website.Controllers
{
  [Authorize]
  public class AccountController : Controller
  {
    private readonly SarUserManager _userManager;
    ...
    [HttpPost]
    [AllowAnonymous]
    [Route("api/account/sendverificationcode")]
    public async Task<string> SendVerificationCode([FromBody] SendVerificationCodeViewModel model, string returnUrl = null)
    {
      ...
      if (pending == null)
      {
        pending = new PendingUser { Email = model.Email };
      }
    ...
    {
      return await _userManager.FindByIdAsync(HttpContext.User.FindFirstValue(ClaimTypes.NameIdentifier));
    }
